...
#object = S0 ( literal_superposition | bracket1_superposition 
...
#                                                | S0 -> [('+',first)] )
compiled_object_sum = S0 object:first S0 object_ops*:right S0 -> compile_object_sum(left,right) 
