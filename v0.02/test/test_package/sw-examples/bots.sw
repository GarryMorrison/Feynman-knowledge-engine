...
supported-ops |bot: Emma> => |op: name> + |op: mother> + |op: father> + |op: birth-sign> + |op: number-siblings> + |op: wine-preference> + |op: favourite-fruit> + |op: favourite-music> + |op: favourite-play> + |op: hair-colour> + |op: eye-colour> + |op: where-live> + |op: favourite-holiday-spot> + |op: make-of-car> + |op: religion> + |op: personality-type> + |op: current-emotion> + |op: bed-time> + |op: age>
name |bot: Emma> => |Emma>
...
favourite-holiday-spot |bot: Emma> => |location: Taj Mahal>
...
supported-ops |bot: Madison> => |op: name> + |op: mother> + |op: father> + |op: birth-sign> + |op: number-siblings> + |op: wine-preference> + |op: favourite-fruit> + |op: favourite-music> + |op: favourite-play> + |op: hair-colour> + |op: eye-colour> + |op: where-live> + |op: favourite-holiday-spot> + |op: make-of-car> + |op: religion> + |op: personality-type> + |op: current-emotion> + |op: bed-time> + |op: hungry> + |op: age> + |op: friends>
