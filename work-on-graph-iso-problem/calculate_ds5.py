...
def improved_ds5(values):
  r11,r12,r13,r14,r15,r21,r22,r23,r24,r25,r31,r32,r33,r34,r35,r41,r42,r43,r44,r45,r51,r52,r53,r54,r55 = values
  return (-r11*r22*r33*r44*r55 + -r11*r22*r33*r45*r54 + -r11*r22*r34*r43*r55 + -r11*r22*r34*r45*r53 + -r11*r22*r35*r43*r54
  + -r11*r22*r35*r44*r53 + -r11*r23*r32*r44*r55 + -r11*r23*r32*r45*r54 + -r11*r23*r34*r42*r55 + -r11*r23*r34*r45*r52
  + -r11*r23*r35*r42*r54 + -r11*r23*r35*r44*r52 + -r11*r24*r32*r43*r55 + -r11*r24*r32*r45*r53 + -r11*r24*r33*r42*r55
  + -r11*r24*r33*r45*r52 + -r11*r24*r35*r42*r53 + -r11*r24*r35*r43*r52 + -r11*r25*r32*r43*r54 + -r11*r25*r32*r44*r53
  + -r11*r25*r33*r42*r54 + -r11*r25*r33*r44*r52 + -r11*r25*r34*r42*r53 + -r11*r25*r34*r43*r52 + -r12*r21*r33*r44*r55
  + -r12*r21*r33*r45*r54 + -r12*r21*r34*r43*r55 + -r12*r21*r34*r45*r53 + -r12*r21*r35*r43*r54 + -r12*r21*r35*r44*r53
  + -r12*r23*r31*r44*r55 + -r12*r23*r31*r45*r54 + -r12*r23*r34*r41*r55 + -r12*r23*r34*r45*r51 + -r12*r23*r35*r41*r54
  + -r12*r23*r35*r44*r51 + -r12*r24*r31*r43*r55 + -r12*r24*r31*r45*r53 + -r12*r24*r33*r41*r55 + -r12*r24*r33*r45*r51
  + -r12*r24*r35*r41*r53 + -r12*r24*r35*r43*r51 + -r12*r25*r31*r43*r54 + -r12*r25*r31*r44*r53 + -r12*r25*r33*r41*r54
  + -r12*r25*r33*r44*r51 + -r12*r25*r34*r41*r53 + -r12*r25*r34*r43*r51 + -r13*r21*r32*r44*r55 + -r13*r21*r32*r45*r54
  + -r13*r21*r34*r42*r55 + -r13*r21*r34*r45*r52 + -r13*r21*r35*r42*r54 + -r13*r21*r35*r44*r52 + -r13*r22*r31*r44*r55
  + -r13*r22*r31*r45*r54 + -r13*r22*r34*r41*r55 + -r13*r22*r34*r45*r51 + -r13*r22*r35*r41*r54 + -r13*r22*r35*r44*r51
  + -r13*r24*r31*r42*r55 + -r13*r24*r31*r45*r52 + -r13*r24*r32*r41*r55 + -r13*r24*r32*r45*r51 + -r13*r24*r35*r41*r52
  + -r13*r24*r35*r42*r51 + -r13*r25*r31*r42*r54 + -r13*r25*r31*r44*r52 + -r13*r25*r32*r41*r54 + -r13*r25*r32*r44*r51
  + -r13*r25*r34*r41*r52 + -r13*r25*r34*r42*r51 + -r14*r21*r32*r43*r55 + -r14*r21*r32*r45*r53 + -r14*r21*r33*r42*r55
  + -r14*r21*r33*r45*r52 + -r14*r21*r35*r42*r53 + -r14*r21*r35*r43*r52 + -r14*r22*r31*r43*r55 + -r14*r22*r31*r45*r53
  + -r14*r22*r33*r41*r55 + -r14*r22*r33*r45*r51 + -r14*r22*r35*r41*r53 + -r14*r22*r35*r43*r51 + -r14*r23*r31*r42*r55
  + -r14*r23*r31*r45*r52 + -r14*r23*r32*r41*r55 + -r14*r23*r32*r45*r51 + -r14*r23*r35*r41*r52 + -r14*r23*r35*r42*r51
  + -r14*r25*r31*r42*r53 + -r14*r25*r31*r43*r52 + -r14*r25*r32*r41*r53 + -r14*r25*r32*r43*r51 + -r14*r25*r33*r41*r52
  + -r14*r25*r33*r42*r51 + -r15*r21*r32*r43*r54 + -r15*r21*r32*r44*r53 + -r15*r21*r33*r42*r54 + -r15*r21*r33*r44*r52
  + -r15*r21*r34*r42*r53 + -r15*r21*r34*r43*r52 + -r15*r22*r31*r43*r54 + -r15*r22*r31*r44*r53 + -r15*r22*r33*r41*r54
  + -r15*r22*r33*r44*r51 + -r15*r22*r34*r41*r53 + -r15*r22*r34*r43*r51 + -r15*r23*r31*r42*r54 + -r15*r23*r31*r44*r52
  + -r15*r23*r32*r41*r54 + -r15*r23*r32*r44*r51 + -r15*r23*r34*r41*r52 + -r15*r23*r34*r42*r51 + -r15*r24*r31*r42*r53
  + -r15*r24*r31*r43*r52 + -r15*r24*r32*r41*r53 + -r15*r24*r32*r43*r51 + -r15*r24*r33*r41*r52 + -r15*r24*r33*r42*r51
  + -6*r11*r21*r31*r42*r55 + -6*r11*r21*r31*r43*r54 + -6*r11*r21*r31*r44*r53 + -6*r11*r21*r31*r45*r52 + -6*r11*r21*r32*r41*r55
  + -6*r11*r21*r32*r45*r51 + -6*r11*r21*r33*r41*r54 + -6*r11*r21*r33*r44*r51 + -6*r11*r21*r34*r41*r53 + -6*r11*r21*r34*r43*r51
  + -6*r11*r21*r35*r41*r52 + -6*r11*r21*r35*r42*r51 + -6*r11*r22*r31*r41*r55 + -6*r11*r22*r31*r45*r51 + -6*r11*r22*r32*r42*r53
  + -6*r11*r22*r32*r43*r52 + -6*r11*r22*r33*r42*r52 + -6*r11*r22*r34*r44*r54 + -6*r11*r22*r35*r41*r51 + -6*r11*r23*r31*r41*r54
  + -6*r11*r23*r31*r44*r51 + -6*r11*r23*r32*r42*r52 + -6*r11*r23*r33*r43*r55 + -6*r11*r23*r33*r45*r53 + -6*r11*r23*r34*r41*r51
  + -6*r11*r23*r35*r43*r53 + -6*r11*r24*r31*r41*r53 + -6*r11*r24*r31*r43*r51 + -6*r11*r24*r32*r44*r54 + -6*r11*r24*r33*r41*r51
  + -6*r11*r24*r34*r42*r54 + -6*r11*r24*r34*r44*r52 + -6*r11*r24*r35*r45*r55 + -6*r11*r25*r31*r41*r52 + -6*r11*r25*r31*r42*r51
  + -6*r11*r25*r32*r41*r51 + -6*r11*r25*r33*r43*r53 + -6*r11*r25*r34*r45*r55 + -6*r11*r25*r35*r44*r55 + -6*r11*r25*r35*r45*r54
  + -6*r12*r21*r31*r41*r55 + -6*r12*r21*r31*r45*r51 + -6*r12*r21*r32*r42*r53 + -6*r12*r21*r32*r43*r52 + -6*r12*r21*r33*r42*r52
  + -6*r12*r21*r34*r44*r54 + -6*r12*r21*r35*r41*r51 + -6*r12*r22*r31*r42*r53 + -6*r12*r22*r31*r43*r52 + -6*r12*r22*r32*r41*r53
  + -6*r12*r22*r32*r43*r51 + -6*r12*r22*r32*r44*r55 + -6*r12*r22*r32*r45*r54 + -6*r12*r22*r33*r41*r52 + -6*r12*r22*r33*r42*r51
  + -6*r12*r22*r34*r42*r55 + -6*r12*r22*r34*r45*r52 + -6*r12*r22*r35*r42*r54 + -6*r12*r22*r35*r44*r52 + -6*r12*r23*r31*r42*r52
  + -6*r12*r23*r32*r41*r52 + -6*r12*r23*r32*r42*r51 + -6*r12*r23*r33*r43*r54 + -6*r12*r23*r33*r44*r53 + -6*r12*r23*r34*r43*r53
  + -6*r12*r23*r35*r45*r55 + -6*r12*r24*r31*r44*r54 + -6*r12*r24*r32*r42*r55 + -6*r12*r24*r32*r45*r52 + -6*r12*r24*r33*r43*r53
  + -6*r12*r24*r34*r41*r54 + -6*r12*r24*r34*r44*r51 + -6*r12*r24*r35*r42*r52 + -6*r12*r25*r31*r41*r51 + -6*r12*r25*r32*r42*r54
  + -6*r12*r25*r32*r44*r52 + -6*r12*r25*r33*r45*r55 + -6*r12*r25*r34*r42*r52 + -6*r12*r25*r35*r43*r55 + -6*r12*r25*r35*r45*r53
  + -6*r13*r21*r31*r41*r54 + -6*r13*r21*r31*r44*r51 + -6*r13*r21*r32*r42*r52 + -6*r13*r21*r33*r43*r55 + -6*r13*r21*r33*r45*r53
  + -6*r13*r21*r34*r41*r51 + -6*r13*r21*r35*r43*r53 + -6*r13*r22*r31*r42*r52 + -6*r13*r22*r32*r41*r52 + -6*r13*r22*r32*r42*r51
  + -6*r13*r22*r33*r43*r54 + -6*r13*r22*r33*r44*r53 + -6*r13*r22*r34*r43*r53 + -6*r13*r22*r35*r45*r55 + -6*r13*r23*r31*r43*r55
  + -6*r13*r23*r31*r45*r53 + -6*r13*r23*r32*r43*r54 + -6*r13*r23*r32*r44*r53 + -6*r13*r23*r33*r41*r55 + -6*r13*r23*r33*r42*r54
  + -6*r13*r23*r33*r44*r52 + -6*r13*r23*r33*r45*r51 + -6*r13*r23*r34*r42*r53 + -6*r13*r23*r34*r43*r52 + -6*r13*r23*r35*r41*r53
  + -6*r13*r23*r35*r43*r51 + -6*r13*r24*r31*r41*r51 + -6*r13*r24*r32*r43*r53 + -6*r13*r24*r33*r42*r53 + -6*r13*r24*r33*r43*r52
  + -6*r13*r24*r34*r44*r55 + -6*r13*r24*r34*r45*r54 + -6*r13*r24*r35*r44*r54 + -6*r13*r25*r31*r43*r53 + -6*r13*r25*r32*r45*r55
  + -6*r13*r25*r33*r41*r53 + -6*r13*r25*r33*r43*r51 + -6*r13*r25*r34*r44*r54 + -6*r13*r25*r35*r42*r55 + -6*r13*r25*r35*r45*r52
  + -6*r14*r21*r31*r41*r53 + -6*r14*r21*r31*r43*r51 + -6*r14*r21*r32*r44*r54 + -6*r14*r21*r33*r41*r51 + -6*r14*r21*r34*r42*r54
  + -6*r14*r21*r34*r44*r52 + -6*r14*r21*r35*r45*r55 + -6*r14*r22*r31*r44*r54 + -6*r14*r22*r32*r42*r55 + -6*r14*r22*r32*r45*r52
  + -6*r14*r22*r33*r43*r53 + -6*r14*r22*r34*r41*r54 + -6*r14*r22*r34*r44*r51 + -6*r14*r22*r35*r42*r52 + -6*r14*r23*r31*r41*r51
  + -6*r14*r23*r32*r43*r53 + -6*r14*r23*r33*r42*r53 + -6*r14*r23*r33*r43*r52 + -6*r14*r23*r34*r44*r55 + -6*r14*r23*r34*r45*r54
  + -6*r14*r23*r35*r44*r54 + -6*r14*r24*r31*r42*r54 + -6*r14*r24*r31*r44*r52 + -6*r14*r24*r32*r41*r54 + -6*r14*r24*r32*r44*r51
  + -6*r14*r24*r33*r44*r55 + -6*r14*r24*r33*r45*r54 + -6*r14*r24*r34*r41*r52 + -6*r14*r24*r34*r42*r51 + -6*r14*r24*r34*r43*r55
  + -6*r14*r24*r34*r45*r53 + -6*r14*r24*r35*r43*r54 + -6*r14*r24*r35*r44*r53 + -6*r14*r25*r31*r45*r55 + -6*r14*r25*r32*r42*r52
  + -6*r14*r25*r33*r44*r54 + -6*r14*r25*r34*r43*r54 + -6*r14*r25*r34*r44*r53 + -6*r14*r25*r35*r41*r55 + -6*r14*r25*r35*r45*r51
  + -6*r15*r21*r31*r41*r52 + -6*r15*r21*r31*r42*r51 + -6*r15*r21*r32*r41*r51 + -6*r15*r21*r33*r43*r53 + -6*r15*r21*r34*r45*r55
  + -6*r15*r21*r35*r44*r55 + -6*r15*r21*r35*r45*r54 + -6*r15*r22*r31*r41*r51 + -6*r15*r22*r32*r42*r54 + -6*r15*r22*r32*r44*r52
  + -6*r15*r22*r33*r45*r55 + -6*r15*r22*r34*r42*r52 + -6*r15*r22*r35*r43*r55 + -6*r15*r22*r35*r45*r53 + -6*r15*r23*r31*r43*r53
  + -6*r15*r23*r32*r45*r55 + -6*r15*r23*r33*r41*r53 + -6*r15*r23*r33*r43*r51 + -6*r15*r23*r34*r44*r54 + -6*r15*r23*r35*r42*r55
  + -6*r15*r23*r35*r45*r52 + -6*r15*r24*r31*r45*r55 + -6*r15*r24*r32*r42*r52 + -6*r15*r24*r33*r44*r54 + -6*r15*r24*r34*r43*r54
  + -6*r15*r24*r34*r44*r53 + -6*r15*r24*r35*r41*r55 + -6*r15*r24*r35*r45*r51 + -6*r15*r25*r31*r44*r55 + -6*r15*r25*r31*r45*r54
  + -6*r15*r25*r32*r43*r55 + -6*r15*r25*r32*r45*r53 + -6*r15*r25*r33*r42*r55 + -6*r15*r25*r33*r45*r52 + -6*r15*r25*r34*r41*r55
  + -6*r15*r25*r34*r45*r51 + -6*r15*r25*r35*r41*r54 + -6*r15*r25*r35*r42*r53 + -6*r15*r25*r35*r43*r52 + -6*r15*r25*r35*r44*r51
  + 4*r11*r21*r32*r42*r54 + 4*r11*r21*r32*r43*r53 + 4*r11*r21*r32*r44*r52 + 4*r11*r21*r33*r42*r53 + 4*r11*r21*r33*r43*r52
  + 4*r11*r21*r33*r45*r55 + 4*r11*r21*r34*r42*r52 + 4*r11*r21*r34*r44*r55 + 4*r11*r21*r34*r45*r54 + 4*r11*r21*r35*r43*r55
  + 4*r11*r21*r35*r44*r54 + 4*r11*r21*r35*r45*r53 + 4*r11*r22*r31*r42*r54 + 4*r11*r22*r31*r43*r53 + 4*r11*r22*r31*r44*r52
  + 4*r11*r22*r32*r41*r54 + 4*r11*r22*r32*r44*r51 + 4*r11*r22*r32*r45*r55 + 4*r11*r22*r33*r41*r53 + 4*r11*r22*r33*r43*r51
  + 4*r11*r22*r34*r41*r52 + 4*r11*r22*r34*r42*r51 + 4*r11*r22*r35*r42*r55 + 4*r11*r22*r35*r45*r52 + 4*r11*r23*r31*r42*r53
  + 4*r11*r23*r31*r43*r52 + 4*r11*r23*r31*r45*r55 + 4*r11*r23*r32*r41*r53 + 4*r11*r23*r32*r43*r51 + 4*r11*r23*r33*r41*r52
  + 4*r11*r23*r33*r42*r51 + 4*r11*r23*r33*r44*r54 + 4*r11*r23*r34*r43*r54 + 4*r11*r23*r34*r44*r53 + 4*r11*r23*r35*r41*r55
  + 4*r11*r23*r35*r45*r51 + 4*r11*r24*r31*r42*r52 + 4*r11*r24*r31*r44*r55 + 4*r11*r24*r31*r45*r54 + 4*r11*r24*r32*r41*r52
  + 4*r11*r24*r32*r42*r51 + 4*r11*r24*r33*r43*r54 + 4*r11*r24*r33*r44*r53 + 4*r11*r24*r34*r41*r55 + 4*r11*r24*r34*r43*r53
  + 4*r11*r24*r34*r45*r51 + 4*r11*r24*r35*r41*r54 + 4*r11*r24*r35*r44*r51 + 4*r11*r25*r31*r43*r55 + 4*r11*r25*r31*r44*r54
  + 4*r11*r25*r31*r45*r53 + 4*r11*r25*r32*r42*r55 + 4*r11*r25*r32*r45*r52 + 4*r11*r25*r33*r41*r55 + 4*r11*r25*r33*r45*r51
  + 4*r11*r25*r34*r41*r54 + 4*r11*r25*r34*r44*r51 + 4*r11*r25*r35*r41*r53 + 4*r11*r25*r35*r42*r52 + 4*r11*r25*r35*r43*r51
  + 4*r12*r21*r31*r42*r54 + 4*r12*r21*r31*r43*r53 + 4*r12*r21*r31*r44*r52 + 4*r12*r21*r32*r41*r54 + 4*r12*r21*r32*r44*r51
  + 4*r12*r21*r32*r45*r55 + 4*r12*r21*r33*r41*r53 + 4*r12*r21*r33*r43*r51 + 4*r12*r21*r34*r41*r52 + 4*r12*r21*r34*r42*r51
  + 4*r12*r21*r35*r42*r55 + 4*r12*r21*r35*r45*r52 + 4*r12*r22*r31*r41*r54 + 4*r12*r22*r31*r44*r51 + 4*r12*r22*r31*r45*r55
  + 4*r12*r22*r33*r43*r55 + 4*r12*r22*r33*r44*r54 + 4*r12*r22*r33*r45*r53 + 4*r12*r22*r34*r41*r51 + 4*r12*r22*r34*r43*r54
  + 4*r12*r22*r34*r44*r53 + 4*r12*r22*r35*r41*r55 + 4*r12*r22*r35*r43*r53 + 4*r12*r22*r35*r45*r51 + 4*r12*r23*r31*r41*r53
  + 4*r12*r23*r31*r43*r51 + 4*r12*r23*r32*r43*r55 + 4*r12*r23*r32*r44*r54 + 4*r12*r23*r32*r45*r53 + 4*r12*r23*r33*r41*r51
  + 4*r12*r23*r33*r42*r55 + 4*r12*r23*r33*r45*r52 + 4*r12*r23*r34*r42*r54 + 4*r12*r23*r34*r44*r52 + 4*r12*r23*r35*r42*r53
  + 4*r12*r23*r35*r43*r52 + 4*r12*r24*r31*r41*r52 + 4*r12*r24*r31*r42*r51 + 4*r12*r24*r32*r41*r51 + 4*r12*r24*r32*r43*r54
  + 4*r12*r24*r32*r44*r53 + 4*r12*r24*r33*r42*r54 + 4*r12*r24*r33*r44*r52 + 4*r12*r24*r34*r42*r53 + 4*r12*r24*r34*r43*r52
  + 4*r12*r24*r34*r45*r55 + 4*r12*r24*r35*r44*r55 + 4*r12*r24*r35*r45*r54 + 4*r12*r25*r31*r42*r55 + 4*r12*r25*r31*r45*r52
  + 4*r12*r25*r32*r41*r55 + 4*r12*r25*r32*r43*r53 + 4*r12*r25*r32*r45*r51 + 4*r12*r25*r33*r42*r53 + 4*r12*r25*r33*r43*r52
  + 4*r12*r25*r34*r44*r55 + 4*r12*r25*r34*r45*r54 + 4*r12*r25*r35*r41*r52 + 4*r12*r25*r35*r42*r51 + 4*r12*r25*r35*r44*r54
  + 4*r13*r21*r31*r42*r53 + 4*r13*r21*r31*r43*r52 + 4*r13*r21*r31*r45*r55 + 4*r13*r21*r32*r41*r53 + 4*r13*r21*r32*r43*r51
  + 4*r13*r21*r33*r41*r52 + 4*r13*r21*r33*r42*r51 + 4*r13*r21*r33*r44*r54 + 4*r13*r21*r34*r43*r54 + 4*r13*r21*r34*r44*r53
  + 4*r13*r21*r35*r41*r55 + 4*r13*r21*r35*r45*r51 + 4*r13*r22*r31*r41*r53 + 4*r13*r22*r31*r43*r51 + 4*r13*r22*r32*r43*r55
  + 4*r13*r22*r32*r44*r54 + 4*r13*r22*r32*r45*r53 + 4*r13*r22*r33*r41*r51 + 4*r13*r22*r33*r42*r55 + 4*r13*r22*r33*r45*r52
  + 4*r13*r22*r34*r42*r54 + 4*r13*r22*r34*r44*r52 + 4*r13*r22*r35*r42*r53 + 4*r13*r22*r35*r43*r52 + 4*r13*r23*r31*r41*r52
  + 4*r13*r23*r31*r42*r51 + 4*r13*r23*r31*r44*r54 + 4*r13*r23*r32*r41*r51 + 4*r13*r23*r32*r42*r55 + 4*r13*r23*r32*r45*r52
  + 4*r13*r23*r34*r41*r54 + 4*r13*r23*r34*r44*r51 + 4*r13*r23*r34*r45*r55 + 4*r13*r23*r35*r42*r52 + 4*r13*r23*r35*r44*r55
  + 4*r13*r23*r35*r45*r54 + 4*r13*r24*r31*r43*r54 + 4*r13*r24*r31*r44*r53 + 4*r13*r24*r32*r42*r54 + 4*r13*r24*r32*r44*r52
  + 4*r13*r24*r33*r41*r54 + 4*r13*r24*r33*r44*r51 + 4*r13*r24*r33*r45*r55 + 4*r13*r24*r34*r41*r53 + 4*r13*r24*r34*r42*r52
  + 4*r13*r24*r34*r43*r51 + 4*r13*r24*r35*r43*r55 + 4*r13*r24*r35*r45*r53 + 4*r13*r25*r31*r41*r55 + 4*r13*r25*r31*r45*r51
  + 4*r13*r25*r32*r42*r53 + 4*r13*r25*r32*r43*r52 + 4*r13*r25*r33*r42*r52 + 4*r13*r25*r33*r44*r55 + 4*r13*r25*r33*r45*r54
  + 4*r13*r25*r34*r43*r55 + 4*r13*r25*r34*r45*r53 + 4*r13*r25*r35*r41*r51 + 4*r13*r25*r35*r43*r54 + 4*r13*r25*r35*r44*r53
  + 4*r14*r21*r31*r42*r52 + 4*r14*r21*r31*r44*r55 + 4*r14*r21*r31*r45*r54 + 4*r14*r21*r32*r41*r52 + 4*r14*r21*r32*r42*r51
  + 4*r14*r21*r33*r43*r54 + 4*r14*r21*r33*r44*r53 + 4*r14*r21*r34*r41*r55 + 4*r14*r21*r34*r43*r53 + 4*r14*r21*r34*r45*r51
  + 4*r14*r21*r35*r41*r54 + 4*r14*r21*r35*r44*r51 + 4*r14*r22*r31*r41*r52 + 4*r14*r22*r31*r42*r51 + 4*r14*r22*r32*r41*r51
  + 4*r14*r22*r32*r43*r54 + 4*r14*r22*r32*r44*r53 + 4*r14*r22*r33*r42*r54 + 4*r14*r22*r33*r44*r52 + 4*r14*r22*r34*r42*r53
  + 4*r14*r22*r34*r43*r52 + 4*r14*r22*r34*r45*r55 + 4*r14*r22*r35*r44*r55 + 4*r14*r22*r35*r45*r54 + 4*r14*r23*r31*r43*r54
  + 4*r14*r23*r31*r44*r53 + 4*r14*r23*r32*r42*r54 + 4*r14*r23*r32*r44*r52 + 4*r14*r23*r33*r41*r54 + 4*r14*r23*r33*r44*r51
  + 4*r14*r23*r33*r45*r55 + 4*r14*r23*r34*r41*r53 + 4*r14*r23*r34*r42*r52 + 4*r14*r23*r34*r43*r51 + 4*r14*r23*r35*r43*r55
  + 4*r14*r23*r35*r45*r53 + 4*r14*r24*r31*r41*r55 + 4*r14*r24*r31*r43*r53 + 4*r14*r24*r31*r45*r51 + 4*r14*r24*r32*r42*r53
  + 4*r14*r24*r32*r43*r52 + 4*r14*r24*r32*r45*r55 + 4*r14*r24*r33*r41*r53 + 4*r14*r24*r33*r42*r52 + 4*r14*r24*r33*r43*r51
  + 4*r14*r24*r35*r41*r51 + 4*r14*r24*r35*r42*r55 + 4*r14*r24*r35*r45*r52 + 4*r14*r25*r31*r41*r54 + 4*r14*r25*r31*r44*r51
  + 4*r14*r25*r32*r44*r55 + 4*r14*r25*r32*r45*r54 + 4*r14*r25*r33*r43*r55 + 4*r14*r25*r33*r45*r53 + 4*r14*r25*r34*r41*r51
  + 4*r14*r25*r34*r42*r55 + 4*r14*r25*r34*r45*r52 + 4*r14*r25*r35*r42*r54 + 4*r14*r25*r35*r43*r53 + 4*r14*r25*r35*r44*r52
  + 4*r15*r21*r31*r43*r55 + 4*r15*r21*r31*r44*r54 + 4*r15*r21*r31*r45*r53 + 4*r15*r21*r32*r42*r55 + 4*r15*r21*r32*r45*r52
  + 4*r15*r21*r33*r41*r55 + 4*r15*r21*r33*r45*r51 + 4*r15*r21*r34*r41*r54 + 4*r15*r21*r34*r44*r51 + 4*r15*r21*r35*r41*r53
  + 4*r15*r21*r35*r42*r52 + 4*r15*r21*r35*r43*r51 + 4*r15*r22*r31*r42*r55 + 4*r15*r22*r31*r45*r52 + 4*r15*r22*r32*r41*r55
  + 4*r15*r22*r32*r43*r53 + 4*r15*r22*r32*r45*r51 + 4*r15*r22*r33*r42*r53 + 4*r15*r22*r33*r43*r52 + 4*r15*r22*r34*r44*r55
  + 4*r15*r22*r34*r45*r54 + 4*r15*r22*r35*r41*r52 + 4*r15*r22*r35*r42*r51 + 4*r15*r22*r35*r44*r54 + 4*r15*r23*r31*r41*r55
  + 4*r15*r23*r31*r45*r51 + 4*r15*r23*r32*r42*r53 + 4*r15*r23*r32*r43*r52 + 4*r15*r23*r33*r42*r52 + 4*r15*r23*r33*r44*r55
  + 4*r15*r23*r33*r45*r54 + 4*r15*r23*r34*r43*r55 + 4*r15*r23*r34*r45*r53 + 4*r15*r23*r35*r41*r51 + 4*r15*r23*r35*r43*r54
  + 4*r15*r23*r35*r44*r53 + 4*r15*r24*r31*r41*r54 + 4*r15*r24*r31*r44*r51 + 4*r15*r24*r32*r44*r55 + 4*r15*r24*r32*r45*r54
  + 4*r15*r24*r33*r43*r55 + 4*r15*r24*r33*r45*r53 + 4*r15*r24*r34*r41*r51 + 4*r15*r24*r34*r42*r55 + 4*r15*r24*r34*r45*r52
  + 4*r15*r24*r35*r42*r54 + 4*r15*r24*r35*r43*r53 + 4*r15*r24*r35*r44*r52 + 4*r15*r25*r31*r41*r53 + 4*r15*r25*r31*r42*r52
  + 4*r15*r25*r31*r43*r51 + 4*r15*r25*r32*r41*r52 + 4*r15*r25*r32*r42*r51 + 4*r15*r25*r32*r44*r54 + 4*r15*r25*r33*r41*r51
  + 4*r15*r25*r33*r43*r54 + 4*r15*r25*r33*r44*r53 + 4*r15*r25*r34*r42*r54 + 4*r15*r25*r34*r43*r53 + 4*r15*r25*r34*r44*r52
  + 24*r11*r21*r31*r41*r51 + 24*r12*r22*r32*r42*r52 + 24*r13*r23*r33*r43*r53 + 24*r14*r24*r34*r44*r54 + 24*r15*r25*r35*r45*r55
  + 0 )
...
#      ds55_3 = ds5(boost_values_3)*24
      ...
      ds55_0 = improved_ds5(values)                # P^5 test
      ds55_1 = improved_ds5(boost_values_1)
      ds55_2 = improved_ds5(boost_values_2)
      ds55_3 = improved_ds5(boost_values_3)
